...
The function to collect computational statistics about a module can be seen below;
...
Using this function, the follwoing pass, `count_flops_mg_analysis_pass` is created.
